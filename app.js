...
const APP_META={version:'2.8.3',label:'濱松住宿更新',released:'2026-09-09'};
...
function rowMapActions(r){const ticket=r['Suzuki QR']?`<a href="${esc(r['Suzuki QR'])}" target="_blank" rel="noopener">🎫 入場 QR</a>`:'';return `${mapBtn(r['Google Maps'])}${r['Google Maps']?mapCode(r['Map Code'],r['Map Code Status']):mapCode(r['Map Code'])}${ticket}`;}
